...
y_ios = data_ios['iOS Noise Attack Rounds'].values
...
y_android = data_android['android Noise Attack Rounds'].values
...
plt.ylabel('Noise Attack Rounds', fontweight='bold', fontsize=20)
plt.legend()
