...
y_label_file1 = "iOS Illusion Text Generation Framework Combinations"  
y_label_file2 = "Android Illusion Text Generation Framework Combinations"  
...
ios_moving_avg, ios_upper_band, ios_lower_band = calculate_bollinger_bands(ios_data["ios幻觉文本生成框架的组合数量"])
android_moving_avg, android_upper_band, android_lower_band = calculate_bollinger_bands(android_data["android幻觉文本生成框架的组合数量"])


ax.plot(ios_data["性能排名"], ios_data["ios幻觉文本生成框架的组合数量"], 
        color='blue', label=f'iOS', marker='o', markersize=8, 
        linewidth=2, alpha=0.9, markerfacecolor='blue', markeredgecolor='blue')


ax.plot(android_data["性能排名"], android_data["android幻觉文本生成框架的组合数量"], 
...
ax.set_ylabel("Illusion Text Generation Framework", fontsize=30, fontweight='bold')
...
y_min = min(ios_data["ios幻觉文本生成框架的组合数量"].min(), android_data["android幻觉文本生成框架的组合数量"].min())
y_max = max(ios_data["ios幻觉文本生成框架的组合数量"].max(), android_data["android幻觉文本生成框架的组合数量"].max())
